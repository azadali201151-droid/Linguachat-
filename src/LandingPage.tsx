  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      if (error?.code === 'auth/unauthorized-domain') {
        setErrorMsg('Domain not authorized. Please add this domain in Firebase Console under Authentication -> Settings -> Authorized domains.');
            ...
            >
              ...
              <div className="text-center mb-8">
                ...
                <p className="text-zinc-400 text-sm">
                  Sign in with Google to start learning instantly
                </p>
              </div>
