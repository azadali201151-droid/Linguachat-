...
import { signInAnonymouslyUser, signInWithGoogle } from './lib/firebase';
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            ...
            >
              ...
              <button
                ...
                className="mt-6 w-full py-3 px-4 bg-white hover:bg-zinc-100 text-zinc-900 rounded-xl font-medium transition-colors flex items-center justify-center gap-3 shadow-lg shadow-white/5"
              >
